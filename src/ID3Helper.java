...
public abstract class ID3Helper {
    ...
    public static final String[] ARTIST_FRAME_IDENTIFIERS = new String[] {
    ...
    public static final String[] TITLE_FRAME_IDENTIFIERS = new String[] {
     ...
     * @return
     */
    public static String extractTagValue(AbstractID3v2Tag tag,
            String[] identifiers) {
        for (String identifier : identifiers) {
            if (tag.hasFrameAndBody(identifier)) {
                AbstractTagFrame frame = (AbstractTagFrame) tag
                        .getFrame(identifier);
    ...
    public static String getArtist(MP3File mp3) {
        ...
        if (mp3.hasID3v1Tag()) {
            String s = mp3.getID3v1Tag().getArtist();
    ...
    public static String getTitle(MP3File mp3) {
        ...
        if (mp3.hasID3v1Tag()) {
            String s = mp3.getID3v1Tag().getTitle();
